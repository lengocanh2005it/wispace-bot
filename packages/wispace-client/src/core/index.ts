// Framework-free WISPACE HTTP clients, contracts, validation, retry, and
// cache policy. NestJS config/providers and Redis implementations live in
// `@wispace/wispace-client/adapters`.
...
export { validateShape, ShapeValidationError } from '../utils/validate-shape';
export {
  validateUpstreamUrl,
