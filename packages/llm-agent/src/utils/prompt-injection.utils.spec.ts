...
describe('detectDisclosureProbe (#625)', () => {
  describe('legitimate messages — must NOT be flagged', () => {
    const clean = [
      ...
      'What model answer should I follow for Task 2?',
      'Which model essay is band 8?',
      'What were you told by the teacher? — câu này đúng ngữ pháp chưa?',
      'Please summarize rules for using articles.',
