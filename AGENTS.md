...
| Canonical LLM safety matching (#501)                                                | ✓ Shared raw + canonical candidates cover input/history/tool scans and chat/compaction output prompt/vendor checks; credentials remain raw-only; must-block eval fixtures pin separator/format-character regressions                                                                                                                                                                                                                                     |
