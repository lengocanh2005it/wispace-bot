...
- **Prompt changes fail the eval**: fixtures reference the real chat system prompts by path + sha256 — any prompt edit breaks `promptHash` until the fixture behavior is re-validated and the hash is updated deliberately (no auto-approve).
