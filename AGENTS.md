...
| Messenger verify-intent durability (#821)                                           | ✓ Ref fingerprint only; one active generation per PSID; conditional consume after mapping commit; five-minute stale reconciliation and committed cleanup                                                                                                                          |
