...
| **Learning Data ACL** | Adapts WISPACE data; WISPACE owns goals, scores, and `UserCalendar`. The bot keeps only normalized views/ports needed by its use cases. | `packages/wispace-client/` |
