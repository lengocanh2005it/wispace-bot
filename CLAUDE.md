...
NestJS 12 · TypeScript · TypeORM · PostgreSQL (`ai_chat_bot_db`, shared across bots) · Redis (provisioned for all three bots; HA/failover open — #409) · LLM Provider Abstraction (adapter pattern) · Meta Graph API · Turborepo + npm workspaces
