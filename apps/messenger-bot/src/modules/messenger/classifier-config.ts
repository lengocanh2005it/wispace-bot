...
export interface MessengerClassifierConfig {
  enabled: boolean;
...
export function resolveMessengerClassifierModel(
  config: MessengerClassifierConfig,
): string {
...
export function buildMessengerClassifierConfig(
  getEnv: (key: string) => string | undefined,
): MessengerClassifierConfig {
  return {
    enabled:
