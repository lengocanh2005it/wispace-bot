...
| **Vault runtime secret contract (#653)** | duplicated per-bot bootstrap loaders                 | Shared `@wispace/bot-common` KV v2 loader + canonical shared/per-bot paths and Vault-only production delivery — [vault-secrets.md](vault-secrets.md); legacy Doppler removal remains #655 | Done (#653/#654) |
