...
| Canonical LLM safety matching (#501)           | Diacritics, separators, format characters, and confusables could bypass shared input or final-output checks                                            | **Done (#501)** — shared raw + canonical candidates in `@wispace/llm-agent`; centralized input/history/tool scanning; prompt/vendor output checks cover chat + compaction; credential shapes remain raw-only; separator/format regressions are must-block fixtures                                                                                                                              | **Done** (#501)    |
