...
| Learner-level cross-platform state (#637)      | Linked channels could split quota, reminders, or daily-report claims                                                                                   | **Done (#637)** — canonical numeric WISPACE `userId`; shared daily FREE_FORM usage, canonical reminder owner, atomic learner report claim, unlink-vs-delete semantics, and current-day compatibility hydration. Related: #512/#458/#510/#461                                                                                                                                                    | **Done**           |
