...
| POST   | `/v1/messenger/privacy/unlink`                  | `{ "externalUserId": string }`                                         | Durable unlink: 200 `complete`, 202 `incomplete` (`cleanupId`, `outstandingStores`), or 409 generation conflict                                                                                   |
| POST   | `/v1/messenger/privacy/delete`                  | `{ "externalUserId": string }`                                         | Durable delete with the same 200/202/409 contract; mutation boolean remains database-only                                                                                                         |
| POST   | `/v1/discord/privacy/unlink`                    | `{ "externalUserId": string }`                                         | Discord own-platform durable unlink with the common 200/202/409 outcome                                                                                                                           |
| POST   | `/v1/discord/privacy/delete`                    | `{ "externalUserId": string }`                                         | Discord own-platform durable delete with the common 200/202/409 outcome                                                                                                                           |
| POST   | `/v1/zalo/privacy/unlink`                       | `{ "externalUserId": string }`                                         | Zalo own-platform durable unlink with the common 200/202/409 outcome                                                                                                                              |
| POST   | `/v1/zalo/privacy/delete`                       | `{ "externalUserId": string }`                                         | Zalo own-platform durable delete with the common 200/202/409 outcome                                                                                                                              |
